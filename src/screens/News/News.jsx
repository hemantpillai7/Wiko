...
const News = ({ navigation }) => {
    ...
    const renderItem = ({ item, index }) => {
        ...
        return (
          <Animated.View style={[AppStyles.animatedCard, { transform: [{ scale }], opacity }]}>
            <TouchableOpacity
              activeOpacity={0.9}
            ...
            >
              ...
              <View style={AppStyles.TextContainer}>
                <Text style={AppStyles.TitleText} numberOfLines={3}>
                  {item.title}
                </Text>
                <Text style={AppStyles.SubText} numberOfLines={4}>
                  {item.info}
                </Text>
                <Text style={AppStyles.SubText} numberOfLines={1}>
